...
# Close and reopen the bank system to test persistence
print("\nRestarting bank system to test persistence...")
bank = None  # Remove the current bank from memory

# Create a new bank system (this will load accounts from file)
new_bank = TamBank()
